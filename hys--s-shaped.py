...
# ------
# Load the data and find its structure..

# Load the `.mat` file
mat_data = loadmat('data/s-shaped-FSV10.mat')

# Print the shapes and types of the key variables.
...
# Calculate the ratios and flatten the arrays to 1D. 
# Using `.item()` to get the single value.
